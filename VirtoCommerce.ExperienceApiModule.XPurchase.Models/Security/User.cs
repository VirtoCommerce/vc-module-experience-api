...
namespace VirtoCommerce.ExperienceApiModule.XPurchase.Models.Security
{
    public partial class User : Entity
    {
        ...
        public bool IsLockedOut => LockoutEndDateUtc != null
            && LockoutEndDateUtc.Value > DateTime.UtcNow;
        ...
        //public IList<ExternalUserLoginInfo> ExternalLogins { get; set; } // todo: check this out
        ...
        //[JsonIgnore]
        //[IgnoreDataMember]
        //public IMutablePagedList<CustomerOrder> Orders { get; set; } // todo: check this out
