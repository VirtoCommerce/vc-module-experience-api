...
{
    public class ShoppingCart : CloneableEntity, IDiscountable, IValidatable, IHasLanguage, ITaxable, ICacheKey
    {
        ...
        public LineItem RecentlyAddedItem => Items.OrderByDescending(i => i.CreatedDate).FirstOrDefault();
