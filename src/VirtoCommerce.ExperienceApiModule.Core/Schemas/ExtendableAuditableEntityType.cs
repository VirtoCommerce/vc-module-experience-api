...
{
    public class ExtendableAuditableEntityType<T> : ExtendableEntityType<T>
        where T : AuditableEntity
    {
        public ExtendableAuditableEntityType()
        {
            Field(x => x.CreatedBy, nullable: true).Description("The ID of user who created the object.");
