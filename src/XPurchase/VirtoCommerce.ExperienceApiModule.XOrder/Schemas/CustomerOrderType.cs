...
namespace VirtoCommerce.ExperienceApiModule.XOrder.Schemas
{
    public class CustomerOrderType : ObjectGraphType<CustomerOrderAggregate>
    {
        public CustomerOrderType()
        {
            ...
            Field<ListGraphType<AddressType>>(nameof(CustomerOrder.Addresses), resolve: x => x.Source.Order.Addresses);
            Field<ListGraphType<OrderLineItemType>>(nameof(CustomerOrder.Items), resolve: x => x.Source.Order.Items);
            Field<ListGraphType<PaymentInType>>(nameof(CustomerOrder.InPayments), resolve: x => x.Source.Order.InPayments);
            Field<ListGraphType<OrderShipmentType>>(nameof(CustomerOrder.Shipments), resolve: x => x.Source.Order.Shipments);
            Field<ListGraphType<OrderTaxDetailType>>(nameof(CustomerOrder.TaxDetails), resolve: x => x.Source.Order.TaxDetails);
            //TODO
