...
namespace VirtoCommerce.XPurchase.Extensions
{
    public static class ServiceCollectionExtensions
    {
        public static IServiceCollection AddXPurchase(this IServiceCollection services)
        {
            ...
            services.AddSchemaType<InputCouponType>();
            services.AddSchemaType<InputCurrencyType>();
            services.AddSchemaType<InputDiscountType>();
            services.AddSchemaType<InputLineItemType>();
            services.AddSchemaType<InputMoneyType>();
            ...
            services.AddSchemaType<InputTaxDetailType>();
