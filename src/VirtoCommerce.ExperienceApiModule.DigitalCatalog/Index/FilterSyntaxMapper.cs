...
namespace VirtoCommerce.ExperienceApiModule.XDigitalCatalog.Index
{
    public static class FilterSyntaxMapper
    {
        ...
        private static IList<FilterToIndexMapper> _allMappers = new List<FilterToIndexMapper>()
        {
            ...
            new RegexpNameMapper(new Regex(@"category.subtree", RegexOptions.Compiled | RegexOptions.IgnoreCase), "__outline_named"),
            new RegexpNameMapper(new Regex(@"categories.subtree", RegexOptions.Compiled | RegexOptions.IgnoreCase), "__outline_named"),
