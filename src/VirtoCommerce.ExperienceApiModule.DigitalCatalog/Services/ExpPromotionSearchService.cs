...
{
    public class ExpPromotionSearchService : IExpPromotionSearchService, IService
    {
        private readonly IPromotionSearchService _promotionSearchService;

        public ExpPromotionSearchService(IPromotionSearchService promotionSearchService)
        {
